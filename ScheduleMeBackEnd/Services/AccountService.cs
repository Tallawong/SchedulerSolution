...
namespace WebApi.Services
{
    public interface IAccountService
    {
        ...
        Task<MfaResponse> AuthenticateWithMfaAsync(AuthenticateRequest model, string ipAddress);
        Task<AuthenticateResponse> VerifyMfaAsync(VerifyMfaRequest model, string ipAddress);
    ...
    public class AccountService : IAccountService
    {
                ...
                try
                {
                    ...
                    if(collection.Count > 0)
                    {
                        throw new AppException(String.Format("Schedule for {0} {1} {2} is already defined for this account", 
                            ...
                            (String.IsNullOrEmpty(scheduleReq.ScheduleGroup) ? "" : "Group: " + scheduleReq.ScheduleGroup)));
                    }
        ...
        */
        ...
        private string generateJwtToken(Account account, bool isTemp = false)
        {
            /*
            ...
            */
            ...
            if (isTemp)
            {
                claims.Add(new Claim("temp", "true"));
            }
            
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(claims),
                Expires = isTemp ? DateTime.UtcNow.AddMinutes(10) : DateTime.UtcNow.AddMinutes(15),
            ...
            var Expires = DateTime.Now.AddMinutes(isTemp ? 10 : 15);
