...
const routes: Routes = [
  { path: '', component: ListComponent },
  {
    path: 'add-edit',
    loadChildren: () =>
      import('./add.edit/add.edit.module').then(
        (x) => x.AddEditModule,
      ) /* component: AddEditComponent */,
  },
  { path: 'import-accounts', component: UploadAccountsComponent },
  {
    path: 'import-timeslots-tasks',
    loadChildren: () =>
      import('./upload-timeslots-tasks/upload-timeslots-tasks.module').then(
        (x) => x.UploadTimeslotsTasksModule,
      ),
  },
